...
public class DBService {
	...
	public void instatiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria", "andersoncleytonalveslopes@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, bpe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "andersonlopes@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, bpe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("12345678", "98765432"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "35478174", cli2, c2);
